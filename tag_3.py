...
# 1. 读取数据并清理
df_q = pd.read_csv('QA片段新增待审批.csv', dtype=str, encoding='utf-8-sig')
df_9 = pd.read_csv('FPV采集数据统计合并结果9片段.csv', dtype=str, encoding='utf-8-sig')
...
# 4. 输出新文件
outname = 'FPV采集数据统计合并结果9片段_with_审批状态.csv'
